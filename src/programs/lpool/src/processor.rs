...
use crate::{
    accounts::{check_account_owner, check_system_program},
    create_platform_mint_program_address_seeds,find_platform_mint_program_address, spl_utils,
...
fn check_transient_stake_address(
    ...
    let (transient_stake_address, bump_seed) =
        crate::find_transient_stake_program_address(
            program_id,
            vote_address,
            stake_pool_address,
            seed,
...
impl Processor {
    ...
    fn process_initialize(
        ...
        let (withdraw_authority_key, stake_withdraw_bump_seed) =
            crate::find_withdraw_authority_program_address(
                program_id,
                stake_pool_info.key,
            );
    ...
    pub fn process_setup(
        ...
        spl_utils::create_program_account_mint_account_with_seed(
            mint_account_info,
