...
async fn setup(
    ...
    for _ in 0..num_validators {
        let stake_account = ValidatorStakeAccount::new(&stake_pool_accounts.stake_pool, u64::MAX);
        create_vote(
            &mut context.banks_client,
            &context.payer,
            &context.last_blockhash,
...
async fn success_with_burned_tokens() {
    ...
    let mint_info = get_account(&mut context.banks_client, &stake_pool_accounts.pool_mint).await;
