...
use crate::{get_tag_program_address, get_tag_record_program_address};
...
pub fn create_tag(program_id: &Pubkey, tag: &str, payer: &Pubkey) -> Instruction {
...
pub fn create_tag_record(
    ...
    let (tag_record_address, tag_record_bump_seed) =
        get_tag_record_program_address(program_id, tag, owner, authority);
