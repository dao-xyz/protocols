...
use shared::account::create_and_serialize_account_signed_verify;
use solana_program::{
...
use crate::{
    ...
    error::PostError,
    state::{
        realm::create_realm_mint_program_address_seeds,
        token_owner_record::{
    ...
    tokens::spl_utils::{
        create_program_token_account, create_spl_token_account_signed, get_spl_token_mint,
        get_spl_token_owner, transfer_spl_tokens,
    },
};
...
pub fn process_deposit_governing_tokens(
    ...
    if governing_token_holding_info.data_is_empty() {
        create_spl_token_account_signed(
            payer_info,
            governing_token_holding_info,
            &create_realm_mint_program_address_seeds(
                governing_token_owner_info.key,
