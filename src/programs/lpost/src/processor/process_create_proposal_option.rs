use crate::{
    ...
    error::PostError,
    instruction::{CreatePostType, CreateProposalOptionType},
    state::post::{
    ...
    state::{
        ...
        proposal::{
            get_proposal_data, get_proposal_data_for_channel,
            proposal_option::{
                create_proposal_option_program_address_seeds, ProposalOption, ProposalOptionType,
            },
            proposal_transaction::{
                get_proposal_transaction_address_seeds, ConditionedInstruction, InstructionData,
