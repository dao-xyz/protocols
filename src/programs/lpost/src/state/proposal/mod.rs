...
use self::proposal_option::{ProposalOption, ProposalOptionType};

use super::enums::{InstructionExecutionFlags, ProposalState, VoteTipping};

use super::post::{PostAccount, PostType};
use super::rules::rule::{AcceptenceCriteria, RuleTimeConfig, RuleVoteConfig};
...
pub enum VoteType {
    ...
    SingleChoice { winning_option: Option<u16> },
