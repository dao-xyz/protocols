...
use crate::{
    ...
    tokens::spl_utils::{
        create_spl_token_account_signed, get_spl_token_owner, transfer_spl_tokens,
    },
};
...
pub fn process_deposit_governing_tokens(
    ...
    */
    ...
    let token_owner_record_address_seeds =
        get_token_owner_record_address_seeds(governing_token_mint_info.key, &governing_token_owner);
