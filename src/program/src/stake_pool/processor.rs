...
fn check_validator_stake_address(
    ...
    let (validator_stake_address, _) =
        crate::stake_pool::find_stake_program_address(program_id, vote_address, stake_pool_address);
...
fn check_transient_stake_address(
    ...
    let (transient_stake_address, bump_seed) =
        crate::stake_pool::find_transient_stake_program_address(
            program_id,
            vote_address,
            stake_pool_address,
            seed,
...
impl Processor {
    ...
    fn process_add_validator_to_pool(
        ...
        let (stake_address, bump_seed) = crate::stake_pool::find_stake_program_address(
            program_id,
